...
Контейнер 780. Активный курс — широкая карточка с прогрессом и кнопкой «Продолжить: <урок>». Недоступные — тихий список `neutral-50` без теней, заголовок раздела «Скоро».
