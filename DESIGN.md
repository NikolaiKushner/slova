...
- Nav items are **text-base** on a 44px row, so they stay easy to hit on a tablet and a large screen. Group labels stay the small sage caps. Collapsed icon mode keeps the compact 32px target.
